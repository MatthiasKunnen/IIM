...
namespace IIM.Helpers
{
    public static class MailService
    {
        ...
        public static async Task SendMailAsync(string body, string subject, string recipientEmail, string originAddress = null)
        {
            originAddress = originAddress ?? AppSettings.DefaultEmailOrigin;
            using (var client = InitializeSmtp(originAddress))
            {
